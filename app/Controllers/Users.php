...
class Users extends BaseController
{
    ...
    public function requestSmsCode()
    {
        ...
        $mobilePhoneNumber = $this->request->getPost(KEY_MOBILE_PHONE_NUMBER);
        if (in_array($mobilePhoneNumber, specialPhones())) {
            $this->succeed();
            return;
        }
    ...
    public function register()
    {
        ...
        $mobilePhoneNumber = $this->request->getPost(KEY_MOBILE_PHONE_NUMBER);
        $username = $this->request->getPost(KEY_USERNAME);
        $smsCode = $this->request->getPost(KEY_SMS_CODE);
        $avatarUrl = $this->request->getPost(KEY_AVATAR_URL);
    ...
    public function registerBySns()
    {
        ...
        $openId = $this->request->getPost(KEY_OPEN_ID);
    ...
    function bindPhone()
    {
        ...
        $mobile = $this->request->getPost(KEY_MOBILE_PHONE_NUMBER);
        $smsCode = $this->request->getPost(KEY_SMS_CODE);
    ...
    function isRegister()
    {
        ...
        $mobile = $this->request->getGet(KEY_MOBILE_PHONE_NUMBER);
//
...
//        }
    ...
    {
        if ($this->checkIfParamsNotExist($this->request->getPost(), array(KEY_USER_IDS))) {
            return;
        }
        $userIds = $this->request->getPost(KEY_USER_IDS);
    ...
    function userTopic()
    {
        ...
        $username = $this->request->getGet(KEY_USERNAME);
    ...
    public function usersByUsername()
    {
        ...
        $users = $this->userDao->findUsersByUsername($this->request->getGet(KEY_USERNAME));
        $this->succeed($users);
    }
}
