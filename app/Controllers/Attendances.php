...
class Attendances extends BaseController
{
    ...
    public function create()
    {
        ...
        $fromUserId = intval($this->request->getPost(KEY_FROM_USER_ID));
...
//            logInfo("ch: " . json_encode($ch));
    ...
    public function one()
    {
        if ($this->checkIfParamsNotExist($this->request->getGet(), array(KEY_LIVE_ID))) {
            return;
        }
    ...
    public function transfer()
    {
        ...
        $amount = $this->request->getGet(KEY_AMOUNT);
