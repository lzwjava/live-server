...
class BaseDao extends CI_Model
{
    ...
    {
        return array(KEY_ATTENDANCE_ID, KEY_USER_ID, KEY_LIVE_ID, KEY_FROM_USER_ID, KEY_FIRST_NOTIFIED,
            KEY_PRE_NOTIFIED, KEY_NOTIFIED, KEY_WECHAT_NOTIFIED, KEY_VIDEO_NOTIFIED, KEY_ORDER_NO,
            KEY_CREATED, KEY_UPDATED);
    }
    ...
    protected function liveFields()
    {
        return array(KEY_LIVE_ID, KEY_SUBJECT, KEY_RTMP_KEY, KEY_ATTENDANCE_COUNT, KEY_NEED_PAY,
            KEY_COVER_URL, KEY_COURSEWARE_KEY, KEY_LIVE_QRCODE_KEY, KEY_PREVIEW_URL, KEY_AMOUNT, KEY_MAX_PEOPLE, KEY_CONVERSATION_ID,
