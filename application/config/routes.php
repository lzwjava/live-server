...
$route['lives/(\d+)/card']['GET'] = 'lives/invatationCard/$1';
...
$route['withdraws/withdrawAnchor']['GET'] = 'withdraws/withdrawAnchor';
$route['withdraws/withdrawNonAnchor']['GET'] = 'withdraws/withdrawNonAnchor';
